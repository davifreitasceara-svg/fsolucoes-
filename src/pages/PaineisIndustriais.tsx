...
import { ArrowLeft, LayoutTemplate, CheckCircle } from "lucide-react";
import img1 from "@/assets/estrutura_real_5.jpg";
import img2 from "@/assets/camara_fria_real_4.jpg";
import { Header } from "@/components/Header";
import { Footer } from "@/components/Footer";
import { WhatsAppButton } from "@/components/WhatsAppButton";

const features = [
  "Fechamentos termoisolantes em EPS e PUR",
  "Montagem rápida e contenção segura",
  "Isolamento absoluto contra variação térmica",
  "Atendimento a grandes centros de distribuição",
  "Instalação com materiais antichamas homologados",
  "Divisórias modulares e portões seccionados",
];

const photos = [
  { src: img1, alt: "Montagem de painéis isotérmicos industriais" },
  { src: img2, alt: "Fechamento termoisolante para fábrica de grande porte" },
];

export default function PaineisIndustriais() {
  return (
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <section className="relative pt-36 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            Fechamentos termoisolantes em EPS e PUR para montagem rápida e contenção segura contra variação térmica.
          </motion.p>
          ...
          <motion.a
            ...
            href="https://wa.me/5585988543450?text=Ol%C3%A1%2C%20gostaria%20de%20um%20or%C3%A7amento%20para%20Pain%C3%A9is%20Industriais"
            target="_blank"
      ...
      <section className="py-20 bg-[#020617]">
        <div className="container mx-auto px-6">
          ...
          >
            Soluções em <span className="text-primary italic">Isolamento</span>
          </motion.h2>
